...
class TurnFaucetEnvSubset(TurnFaucetBaseEnv):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model_ids = [m_id for m_id in model_ids if m_id in [
            '5002', '5021', '5023', '5028', '5029', '5045', '5047', '5051', '5056', '5063']]
        self.model_id = None
...
class TurnFaucetEnvAll(TurnFaucetBaseEnv):
    target_link: sapien.Link
    target_joint: sapien.Joint
